...
* Reperire i sorgenti del progetto front/back - end.
...
image::quick-start-pet-shop-poc/struttura.png[alt=Struttura, align=center]


== Struttura Front-end
Per accedere al front-end dovete andare al seguente path:

image::quick-start-pet-shop-poc/percorso-front-end.png[alt=Percorso front-en, align=center]

Una volta all'interno dovete aprire la cartella con VS code, la struttura del progetto è spiegata nella guida di link:{angular-guide-url}[Angular]
